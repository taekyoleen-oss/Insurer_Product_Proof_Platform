...
interface AgencyContentShellProps {
...
export function AgencyContentShell({ isAgencyAdmin, userName, agencyName, children }: AgencyContentShellProps) {
  ...
  return (
    ...
    >
      ...
      >
        <AgencySidebar isAgencyAdmin={isAgencyAdmin} userName={userName} agencyName={agencyName} />
      </div>
